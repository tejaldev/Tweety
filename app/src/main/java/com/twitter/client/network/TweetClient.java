package com.twitter.client.network;
...
public class TweetClient extends OAuthBaseClient {
    ...
    public static final String SEARCH_TWEETS_RELATIVE_URL = "search/tweets.json";
	 ...
	 */
	public void getHomeTimelineTweets(RequestParams params, AsyncHttpResponseHandler responseHandler) {
		String apiUrl = getApiUrl(HOME_TIMELINE_TWEETS_RELATIVE_URL);
		// Can specify query string params directly or through RequestParams.
		RequestParams requestParams = buildRequestParams(params);
		client.get(apiUrl, requestParams, responseHandler);
	}

	public void getUserDetails(RequestParams params, AsyncHttpResponseHandler responseHandler) {
    ...
    public void getSearchQueryResults(RequestParams params, AsyncHttpResponseHandler responseHandler) {
        String apiUrl = getApiUrl(SEARCH_TWEETS_RELATIVE_URL);
        // Can specify query string params directly or through RequestParams.
        RequestParams requestParams = buildRequestParams(params);
        client.get(apiUrl, requestParams, responseHandler);
    }
